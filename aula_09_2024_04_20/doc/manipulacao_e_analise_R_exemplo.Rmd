...
txo_antes <- read_sheet("https://Linkdogooglesheets", sheet = 1, col_types = "?cnnn")
txo_depois <- read_sheet("https://Linkdogooglesheets", sheet = 2,col_types = "?cnnn")
...
txo_anual_xxxx <- read_sheet("Linkdogooglesheets", sheet = 4,col_types = "?n")
